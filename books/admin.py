...
from books.models import BorrowedBookDashboard
...
class BookAdmin(admin.ModelAdmin):
    ...
    # change_list_template = 'admin/books/book_changelist.html'
    change_list_template = 'books/admin/book_changelist.html'
    ...
    def toggle_availability(self, book):
        link = reverse('admin:books-availability-toggle', args=[book.pk])
    ...
    def get_urls(self):
        ...
        custom_urls = [
            url(r'^(?P<book_id>.+)/availability-toggle$',
                self.admin_site.admin_view(self.toggle_book_availability), name='books-availability-toggle',
                ),
        ]
...
class BestSellerAdmin(RelatedFieldAdmin):
    ...
    # list_display = ('id', 'books', 'book__author', 'book__author__name', 'year', 'rank')
    list_display = ('id', 'books', 'year', 'rank')

    # list_display = ('books',)
    # list_display = ('books', 'book__author')

    # list_editable = ('books', 'year', 'rank')
...
class AuthorModelForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        book = self.cleaned_data.get('books', None)
...
class BorrowedBookAdmin(admin.ModelAdmin):
    list_display = ('user', 'borrowed_date')
...
class BorrowedBookDashboardAdmin(admin.ModelAdmin):
    change_list_template = 'books/admin/borrowedbook_changelist.html'
